...
document.querySelectorAll('.mission-card, .section-title, .gallery-item, .vision-container, .platform-card, .metric-card, .pw-section-title, .pw-highlight-card, .pw-video-card').forEach(el => {
    el.style.opacity = '0';
